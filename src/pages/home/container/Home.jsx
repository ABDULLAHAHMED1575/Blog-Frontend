  ...
  return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
        <div className='mt-10 lg:w-1/2'>
            <h1 className='text-3xl font-roboto text-center font-bold text-dark-soft md:text-5xl lg:text-left lg:max-w-[540px]'>Read the most interesting articles</h1>
            ...
            <div className="flex mt-4 flex-col lg:flex-ro0w lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
                <span className="text-dark-light font-semibold mt-2 lg:mt-4 italic">Popular Tags: </span>
